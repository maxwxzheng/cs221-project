...
cast, keywords and release date. These are also our largest feature sets (see Table \ref{table:featuresetsize}).
...
\hline %inserts single line
\end{tabular}
\label{table:featuresetsize} % is used to refer this table in the text
\end{table}
