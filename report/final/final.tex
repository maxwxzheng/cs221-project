...
Our initial implementation of the neural network was quite slow, taking approximately
...
generate the most successful movie. Here are the features with the highest
weights in each feature dimension, learned using SGD:
\begin{center}
...
\par Combining these top features would make for a rather strange movie (e.g. a stop-motion animated documentary based on a play about a cartoon mutant dog set in Italy) made with a budget of \$60M.\\
\textit{Explain these}
\begin{itemize}
    \item why bollywood
