...
Linear regression was somewhat susceptible to overfitting, and is not tunable, so we used
...
generate the most successful movie. Using features with the largest weights
learned using SGD, the following would be features of our super movie:
\begin{itemize}
    \item Budget: 60,000,000
    \item Genre: Documentary
    \item Released in New York in March

    \item Actor: Jim Fitzpatrick
    \item Actor: Ashish Vidyarthi
    \item Actor: Dennis Quaid
    \item Actor: George W. Bush
    \item Actor: Stellan Skarsgård
    \item Actor: Donald Trump
    \item Actor: William Shatner
    \item Actor: Jon Gries
    \item Actor: Alan Oppenheimer

    \item Actress: Bipasha Basu
    \item Actress: Divya Dutta
    \item Actress: Susan Tyrrell
    \item Actress: Kiran Juneja
    \item Actress: Tabu
    \item Actress: Milena Vukotic
    \item Actress: Dolly Ahluwalia
    \item Actress: Mona Marshall
    \item Actress: Karen Strassman
    \item Actress: Elizabeth Daily
    \item Actress: Agnes Bruckner

    \item Producer: Sunil Lulla
    \item Producer: Siddharth Roy Kapur
    \item Producer: Aashish Singh
    \item Producer: Peter Newman
    \item Producer: Padam Bhushan

    \item Director: Imtiaz Ali
    \item Director: Vishal Bhardwaj
    \item Director: Don Coscarelli
    \item Director: Jonathan Demme
    \item Director: Tony Gatlif

    \item Keyword: stop-motion-animation
    \item Keyword: based-on-play
    \item Keyword: cartoon-dog
    \item Keyword: mutant
    \item Keyword: splatter
    \item Keyword: italy
    \item Keyword: ampersand-in-title
    \item Keyword: splatter
    \item Keyword: first-part
    \item Keyword: cliff
