...
Budget $\times$ Cast & \textbf{x} & \textbf{x} \\
Actor $\times$ Director & \textbf{x} & \textbf{x} \\
...
Budget $\times$ Cast & \textbf{x} & \textbf{x} & \textbf{x} \\
Actor $\times$ Director & \textbf{x} & \textbf{x} & \textbf{x} \\
[1ex]
\hline %inserts single line
\end{tabular}
