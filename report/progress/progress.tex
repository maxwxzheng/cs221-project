...
When represented sparsely, the feature size without combinations is about 53MB, and 82MB with combinations,
indicating that many of the features are not associated with many movies.  The same data represented
densely consumes approximately 3.5GB and 14GB respectively. \\

\textbf{INSERT HISTOGRAM OF UNIQUE FEATURE TO MOVIE COUNT} \\ \\
