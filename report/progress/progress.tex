...
We believe the improvement is mostly from feature tuning. For next steps, we
plan to focus more on improving the performance of Neural Network by tuning the
network topology to see if it can do better than Linear Regression. We also
plan to experiment more on SVM with different kernels.
